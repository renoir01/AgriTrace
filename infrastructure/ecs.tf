# ECS (Elastic Container Service) Infrastructure for AgriTrace
...
# Policy for ECS Task Role to access SSM parameters
      ...
      environment = [
        {
          ...
          value = "agritrace_project.settings.production"
        },
        {
